...
async def run(
    ...
    yield {
        "type": "text",
        "text": (
            "_This query was classified as a concept question, so no "
            "Portfolio, Stock, or Research Agent is being called. The "
            "answer below is a single grounded LLM call against the "
            "educator system prompt._\n\n"
            "---\n\n"
        ),
        "persona": "moderator",
    }
